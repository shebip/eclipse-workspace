...
public class UserDefinedExceptionExample extends Exception {
  ...
  UserDefinedExceptionExample(String str) {
    super(str);
  }
  ...
  public static void main(String[] args) {
    try {
      ...
      for (int i = 0; i < 5; i++) {
        ...
        if (bal[i] < 1000) {
          UserDefinedExceptionExample me = new UserDefinedExceptionExample("Balance is less than 1000");
          throw me;
        }
      }
    } // end of try

    catch (UserDefinedExceptionExample e) {
      e.printStackTrace();
    }
  }
}
